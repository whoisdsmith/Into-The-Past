...
var ObsidianLinksSettingTab = class extends import_obsidian6.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian6.Setting(containerEl).setName("Convert multiple links to markdown links").setDesc("Convert multiple links in note or selection to markdown links.").setClass("setting-item--insider-feature2").addToggle((toggle) => {
