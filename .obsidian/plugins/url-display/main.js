...
var UrlDisplaySettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Hover link preview").setDesc("if enabled, hovering over a URL item will display its hyperlink address.").addToggle(
    ...
    new import_obsidian.Setting(containerEl).setName("Copy format").setDesc("Choose the format of the copied URL.").addDropdown((value) => {
      value.addOptions({ justLink: "link", inlineLink: "[alias/title](link)" }).setValue(this.plugin.settings.copyFormat).onChange((value2) => {
...
var UrlDisplayView = class extends import_obsidian2.ItemView {
  constructor(leaf, plugin, processor) {
    ...
    this.handlerContextmenu = (event) => {
      ...
      const delegatedElement = event.currentTarget;
      menu.addItem(
        (item) => item.setTitle("Copy URL").setIcon("copy").onClick((event2) => {
          ...
          new import_obsidian2.Notice("URL copied to your clipboard.");
        })
      );
      menu.addItem(
        (item) => item.setTitle("Search for URL").setIcon("search").onClick((event2) => {
          ...
          if (leaf) {
            ...
            new import_obsidian2.Notice("Need to enable Search core plugin.");
          }
        })
      );
